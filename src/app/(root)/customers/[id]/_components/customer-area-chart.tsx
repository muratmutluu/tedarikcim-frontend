...
import { useCustomerDailyTransactions } from "@/hooks/customers/use-customer-daily-transactions";
...
export function CustomerAreaChart({ customerId }: { customerId: number }) {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useCustomerDailyTransactions(customerId, days);
  ...
  if (isLoading) {
    return (
      <Card className="@container/card">
        <CardHeader>
          <CardTitle>Günler Göre Toplam Müşteri Başına İşlemler</CardTitle>
    ...
    return (
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardDescription>Veri yüklenirken hata oluştu</CardDescription>
        </CardHeader>
        <CardContent>
