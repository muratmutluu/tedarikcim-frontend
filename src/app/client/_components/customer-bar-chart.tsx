...
import { useCustomerMonthlyTransactionsAverage } from "@/hooks/customers/use-customer-stats";
...
export function CustomerBarChart({ customerId }: { customerId: number }) {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useCustomerMonthlyTransactionsAverage(customerId, yearNumber);
  ...
  return (
    <Card className="@container/card justify-between">
      <CardHeader className="relative">
        <CardTitle>Aylara Göre Ortalama Müşteri Başına İşlemler</CardTitle>
